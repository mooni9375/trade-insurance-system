package com.tradeinsurance.reviewdomaincore.entity;
...
import com.tradeinsurance.reviewdomaincore.exception.ReviewDomainException;
...
public class Review extends AggregateRoot<ReviewId> {
    ...
    public void initializeReview() {
        ...
        // 고위험국인 경우 부보율과 할인율 각각 50%, 30%로 생성.
        // 단, 심사 담당자가 변경 가능.
